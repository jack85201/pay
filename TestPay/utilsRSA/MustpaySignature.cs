...
namespace Common.Payment.UtilRSA
{
    public class MustpaySignature
    {
        ...
        public static bool RSACheckV3(IDictionary<string, string> parameters, string publicKeyPem, string charset, bool keyFromFile)
        {
            string sign = parameters["sign"];
        ...
        public static string CheckSignAndDecrypt(IDictionary<string, string> parameters, string MustpayPublicKey,
                                             ...
                                             bool isDecrypt)
        {
            ...
            if (isCheckSign)
            {
                if (!RSACheckV2(parameters, MustpayPublicKey, charset))
                {
        ...
        public static string encryptAndSign(string bizContent, string MustpayPublicKey,
                                        ...
                                        bool isSign)
        {
            ...
            {// 加密
                sb.Append("<mustpay>");
                String encrypted = RSAEncrypt(bizContent, MustpayPublicKey, charset);
